...
const Sidebar = () => {
    ...
    return (
        <div className={'lg:w-1/6 w-full h-[55px]'}>
            ...
            <div className={`bg-gray-500 lg:w-1/6 h-full flex flex-col lg:items-center px-4 lg:p-0 fixed inset-0 transform ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'} transition-transform duration-300 lg:translate-x-0`}>
