...
const AppStats = () => {
    ...
    return (
        <div className={'flex flex-col w-full'}>
            <h2 className="text-2xl lg:flex flex-col justify-between">Статистика по приложению <p className={'text-xl pt-2'}>Онлайн: {activeUsers} <span className={'w-2 h-2 text-green-500'}>&#9679;</span></p> </h2>
            <div className={'h-2/6'}>
